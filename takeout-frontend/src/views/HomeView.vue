          ...
          >
            ...
            <div class="shop-info">
              ...
              <div class="shop-meta">
                ...
                <span class="sales">{{ shop.sales }}月售</span>
                <span class="delivery-time">⏱️ {{ shop.deliveryTime }}分钟</span>
              </div>
...
const popularShops = ref([
  { id: 1, name: '麦当劳', emoji: '🍔', rating: 4.8, sales: 9999, deliveryTime: 25, description: '西式快餐，汉堡薯条' },
  { id: 2, name: '肯德基', emoji: '🍗', rating: 4.7, sales: 8888, deliveryTime: 30, description: '炸鸡专家，美味到家' },
  { id: 3, name: '必胜客', emoji: '🍕', rating: 4.6, sales: 7777, deliveryTime: 35, description: '比萨专家，意面小吃' },
  { id: 4, name: '海底捞', emoji: '🍲', rating: 4.9, sales: 6666, deliveryTime: 40, description: '火锅专家，配送到家' },
  { id: 5, name: '真功夫', emoji: '🍜', rating: 4.5, sales: 5555, deliveryTime: 28, description: '中式快餐，营养健康' },
  { id: 6, name: '喜茶', emoji: '🧋', rating: 4.8, sales: 4444, deliveryTime: 20, description: '新式茶饮，网红打卡' },
])
